...
\"\n\
checkout_executable TCLSH \"/home/administrator/ns-allinone-2.34/bin/tclsh8.4\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/administrator/ns-allinone-2.34/bin/tclsh8.4\n\
but it doesn't seem to be there anymore, so\\\n\
...
AOMDV\n\
AntHocNet # routing protocol for ad-hoc networks basead in antnet\n\
...
\n\
Agent/AntHocNet set num_nodes_ 2\n\
Agent/AntHocNet set num_nodes_x_ 2\n\
...
AntHocNet {\n\
set ragent [$self create-ahn-agent $node]\n\
}\n\
TORA {\n\
