...
| Data routing exponent | **2** (squared) | 3.2 | `betaData = 20` | ⚠️ deviates — the 2007 thesis sets β₃ = 20 and a 20-seed paired A/B favoured it (#179) |
| Ant routing exponent | **1** (unsquared) | 3.3 | `betaAnts = 20` | ⚠️ deviates — thesis β₁ = β₂ = 20 (#179) |
